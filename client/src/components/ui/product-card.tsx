      ...
      >
        ...
        <CardContent className="p-4">
          <div className="flex justify-between items-start mb-2">
            <Link href={`/products/category/${categoryId || 1}`} className="text-muted-foreground text-xs bg-secondary/10 hover:bg-secondary/20 px-2 py-1 rounded-md transition-colors">
